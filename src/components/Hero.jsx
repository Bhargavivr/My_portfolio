    ...
    <section id="home" className="About_dev">
      <div className="content">
        <div className="herotext">
          <h1>Frontend React & Python Developer</h1>

          <p>
            Hi, I am <strong>Bhargavi Reddy</strong> 👋 — an AI & Data Science
            student with strong foundations in frontend development, machine
            learning, and cloud technologies, passionate about building
            real-world solutions based in Bangalore, Karnataka. 📍
          </p>

          <div className="hero-links">
            <a
              className="btnn"
              href="https://github.com/Bhargavivr"
              target="_blank"
        ...
        <div className="heroimg">
          <img src="myimg.png" alt="Bhargavi" />
        </div>
      </div>
    </section>
  );
